// ============================================================
// PROGRESS — Database ingredienti (invariato da VITA)
// ============================================================
...
const DEFAULT_INGREDIENTS = [
  ...
  { id:'ing138', name:'Cavolo cappuccio',        categoryId:'cat06', kcalPer100:25,  proteinPer100:1.3,  carbsPer100:5.8,  fatPer100:0.1,  fiberPer100:2.5  },
  { id:'ing139', name:'Cavolo nero',             categoryId:'cat06', kcalPer100:49,  proteinPer100:4.3,  carbsPer100:8.8,  fatPer100:0.7,  fiberPer100:3.6  },
  { id:'ing140', name:'Bietole',                 categoryId:'cat06', kcalPer100:19,  proteinPer100:1.8,  carbsPer100:3.7,  fatPer100:0.2,  fiberPer100:1.6  },
  { id:'ing141', name:'Carciofi',                categoryId:'cat06', kcalPer100:47,  proteinPer100:3.3,  carbsPer100:10.5, fatPer100:0.2,  fiberPer100:5.4  },
  { id:'ing142', name:'Pomodorini',              categoryId:'cat06', kcalPer100:18,  proteinPer100:0.9,  carbsPer100:3.9,  fatPer100:0.2,  fiberPer100:1.2  },
  { id:'ing143', name:'Cetrioli',                categoryId:'cat06', kcalPer100:15,  proteinPer100:0.7,  carbsPer100:3.6,  fatPer100:0.1,  fiberPer100:0.5  },
  { id:'ing144', name:'Radicchio',               categoryId:'cat06', kcalPer100:23,  proteinPer100:1.4,  carbsPer100:4.5,  fatPer100:0.3,  fiberPer100:3.0  },
  { id:'ing145', name:'Rucola',                  categoryId:'cat06', kcalPer100:25,  proteinPer100:2.6,  carbsPer100:3.7,  fatPer100:0.7,  fiberPer100:1.6  },
  { id:'ing146', name:'Cicoria',                 categoryId:'cat06', kcalPer100:23,  proteinPer100:1.7,  carbsPer100:4.7,  fatPer100:0.3,  fiberPer100:4.0  },
  { id:'ing147', name:'Scarola',                 categoryId:'cat06', kcalPer100:17,  proteinPer100:1.3,  carbsPer100:3.4,  fatPer100:0.2,  fiberPer100:3.2  },
  // FRUTTA
...
export const INGREDIENTS = DEFAULT_INGREDIENTS;
